.class public Lcom/m0narx/tweaks/fragments/contacts_settings;
.super Lcom/m0narx/tweaks/custompreferences/Prefs;
.source "contacts_settings.java"
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->SIZE_MIN:I

    .line 17
    iput v2, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->SIZE_MAX:I

    .line 18
    iput v1, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->SIZE_STEP:I

    .line 20
    const/16 v0, 0x32

    iput v0, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->VIBRATION_MIN:I

    .line 21
    iput v2, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->VIBRATION_MAX:I

    .line 22
    iput v1, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->VIBRATION_STEP:I
...
.method private setSliders()V
    ...
    .prologue
    .line 112
    iget-object v3, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->Cr:Landroid/content/ContentResolver;
    ...
    invoke-virtual {p0, v3}, Lcom/m0narx/tweaks/fragments/contacts_settings;->findPreference(Ljava/lang/CharSequence;)Lcom/htc/preference/HtcPreference;
...
.method private setVibration()V
    ...
    invoke-virtual {p0, v1}, Lcom/m0narx/tweaks/fragments/contacts_settings;->findPreference(Ljava/lang/CharSequence;)Lcom/htc/preference/HtcPreference;

    move-result-object v0

    .line 103
    .local v0, pref:Lcom/htc/preference/HtcPreference;
    iget-object v1, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->Cr:Landroid/content/ContentResolver;
...
.method public init()V
    ...
    invoke-virtual {p0, v0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->OnClickListener([Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/m0narx/tweaks/fragments/contacts_settings;->OnChangeListener(Ljava/lang/String;Ljava/lang/String;Lcom/m0narx/tweaks/custompreferences/Prefs$PreferenceType;Ljava/lang/Integer;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/m0narx/tweaks/fragments/contacts_settings;->OnChangeListener(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    .line 93
    invoke-direct {p0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->setVibration()V

    .line 94
    invoke-direct {p0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->setSliders()V
...
.method public onPrefClick(Lcom/htc/preference/HtcPreference;)Z
    ...
    iget-object v2, p0, Lcom/m0narx/tweaks/fragments/contacts_settings;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v1}, Lcom/m0narx/tweaks/fragments/contacts_settings;->startActivity(Landroid/content/Intent;)V
...
.method public setHeader()V
    ...
    invoke-virtual {p0, v0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->setActionHtcBarText(I)Lcom/htc/widget/ActionBarContainer;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->enableBackButton(Lcom/htc/widget/ActionBarContainer;)V
...
.method public updateButtons()V
    ...
    .prologue
    .line 32
    invoke-virtual {p0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->updateHeader()V
...
.method public updateHeader()V
    ...
    invoke-virtual {p0, v0}, Lcom/m0narx/tweaks/fragments/contacts_settings;->SetupHeader(Lcom/m0narx/tweaks/widgets/Reboot$Action;)V
